...
# docker run --gpus all --rm -v /home/tonkung/work/upscayl/auto-bot-midjourney-discord/comfy-gen/comfy09:/input -v ./output:/output image-classifier-top --input /input --output /output